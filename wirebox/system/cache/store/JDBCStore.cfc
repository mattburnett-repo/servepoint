...
component implements="wirebox.system.cache.store.IObjectStore" accessors="true" {
	 ...
	 */
	property name="cacheProvider" doc_generic="wirebox.system.cache.providers.ICacheProvider";
	 ...
	 */
	property name="converter" doc_generic="wirebox.system.core.conversion.ObjectMarshaller";
